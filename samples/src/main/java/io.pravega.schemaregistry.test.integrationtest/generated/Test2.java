...
public class Test2 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Test2\",\"namespace\":\"io.pravega.schemaregistry.test.integrationtest.generated\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"field1\",\"type\":\"int\"},{\"name\":\"field2\",\"type\":\"string\"}]}");
   ...
   */
  public Test2(java.lang.CharSequence name, java.lang.Integer field1, java.lang.CharSequence field2) {
    this.name = name;
    this.field1 = field1;
    this.field2 = field2;
  }
   ...
   */
  public static io.pravega.schemaregistry.test.integrationtest.generated.Test2.Builder newBuilder() {
    return new io.pravega.schemaregistry.test.integrationtest.generated.Test2.Builder();
  }
   ...
   * @return A new Test2 RecordBuilder
   */
  public static io.pravega.schemaregistry.test.integrationtest.generated.Test2.Builder newBuilder(io.pravega.schemaregistry.test.integrationtest.generated.Test2.Builder other) {
    if (other == null) {
      return new io.pravega.schemaregistry.test.integrationtest.generated.Test2.Builder();
    } else {
      return new io.pravega.schemaregistry.test.integrationtest.generated.Test2.Builder(other);
    }
  }
   ...
   * @return A new Test2 RecordBuilder
   */
  public static io.pravega.schemaregistry.test.integrationtest.generated.Test2.Builder newBuilder(io.pravega.schemaregistry.test.integrationtest.generated.Test2 other) {
    if (other == null) {
      return new io.pravega.schemaregistry.test.integrationtest.generated.Test2.Builder();
    } else {
      return new io.pravega.schemaregistry.test.integrationtest.generated.Test2.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Test2>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.pravega.schemaregistry.test.integrationtest.generated.Test2.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.pravega.schemaregistry.test.integrationtest.generated.Test2 other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pravega.schemaregistry.test.integrationtest.generated.Test2.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pravega.schemaregistry.test.integrationtest.generated.Test2.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pravega.schemaregistry.test.integrationtest.generated.Test2.Builder setField1(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pravega.schemaregistry.test.integrationtest.generated.Test2.Builder clearField1() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pravega.schemaregistry.test.integrationtest.generated.Test2.Builder setField2(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pravega.schemaregistry.test.integrationtest.generated.Test2.Builder clearField2() {
      field2 = null;
