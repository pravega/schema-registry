...
public class Type3 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static io.pravega.schemaregistry.test.samples.generated.Type3.Builder newBuilder() {
    return new io.pravega.schemaregistry.test.samples.generated.Type3.Builder();
  }
   ...
   * @return A new Type3 RecordBuilder
   */
  public static io.pravega.schemaregistry.test.samples.generated.Type3.Builder newBuilder(io.pravega.schemaregistry.test.samples.generated.Type3.Builder other) {
    if (other == null) {
      return new io.pravega.schemaregistry.test.samples.generated.Type3.Builder();
    } else {
      return new io.pravega.schemaregistry.test.samples.generated.Type3.Builder(other);
    }
  }
   ...
   * @return A new Type3 RecordBuilder
   */
  public static io.pravega.schemaregistry.test.samples.generated.Type3.Builder newBuilder(io.pravega.schemaregistry.test.samples.generated.Type3 other) {
    if (other == null) {
      return new io.pravega.schemaregistry.test.samples.generated.Type3.Builder();
    } else {
      return new io.pravega.schemaregistry.test.samples.generated.Type3.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Type3>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.pravega.schemaregistry.test.samples.generated.Type3.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.pravega.schemaregistry.test.samples.generated.Type3 other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.f)) {
        this.f = data().deepCopy(fields()[0].schema(), other.f);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pravega.schemaregistry.test.samples.generated.Type3.Builder setF(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pravega.schemaregistry.test.samples.generated.Type3.Builder clearF() {
      f = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pravega.schemaregistry.test.samples.generated.Type3.Builder setG(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pravega.schemaregistry.test.samples.generated.Type3.Builder clearG() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pravega.schemaregistry.test.samples.generated.Type3.Builder setH(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pravega.schemaregistry.test.samples.generated.Type3.Builder clearH() {
      h = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pravega.schemaregistry.test.samples.generated.Type3.Builder setI(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pravega.schemaregistry.test.samples.generated.Type3.Builder clearI() {
      i = null;
