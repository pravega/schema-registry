...
public class Type2 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -1723905128005116860L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Type2\",\"namespace\":\"io.pravega.schemaregistry.test.integrationtest.generated\",\"fields\":[{\"name\":\"c\",\"type\":\"string\"},{\"name\":\"d\",\"type\":\"int\"},{\"name\":\"e\",\"type\":\"string\"}]}");
   ...
   */
  public Type2(java.lang.CharSequence c, java.lang.Integer d, java.lang.CharSequence e) {
    this.c = c;
    this.d = d;
    this.e = e;
  }
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: c = (java.lang.CharSequence)value$; break;
    case 1: d = (java.lang.Integer)value$; break;
    case 2: e = (java.lang.CharSequence)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public static io.pravega.schemaregistry.test.integrationtest.generated.Type2.Builder newBuilder() {
    return new io.pravega.schemaregistry.test.integrationtest.generated.Type2.Builder();
  }
   ...
   * @return A new Type2 RecordBuilder
   */
  public static io.pravega.schemaregistry.test.integrationtest.generated.Type2.Builder newBuilder(io.pravega.schemaregistry.test.integrationtest.generated.Type2.Builder other) {
    if (other == null) {
      return new io.pravega.schemaregistry.test.integrationtest.generated.Type2.Builder();
    } else {
      return new io.pravega.schemaregistry.test.integrationtest.generated.Type2.Builder(other);
    }
  }
   ...
   * @return A new Type2 RecordBuilder
   */
  public static io.pravega.schemaregistry.test.integrationtest.generated.Type2.Builder newBuilder(io.pravega.schemaregistry.test.integrationtest.generated.Type2 other) {
    if (other == null) {
      return new io.pravega.schemaregistry.test.integrationtest.generated.Type2.Builder();
    } else {
      return new io.pravega.schemaregistry.test.integrationtest.generated.Type2.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Type2>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.pravega.schemaregistry.test.integrationtest.generated.Type2.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.pravega.schemaregistry.test.integrationtest.generated.Type2 other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.c)) {
        this.c = data().deepCopy(fields()[0].schema(), other.c);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pravega.schemaregistry.test.integrationtest.generated.Type2.Builder setC(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pravega.schemaregistry.test.integrationtest.generated.Type2.Builder clearC() {
      c = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pravega.schemaregistry.test.integrationtest.generated.Type2.Builder setD(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pravega.schemaregistry.test.integrationtest.generated.Type2.Builder clearD() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pravega.schemaregistry.test.integrationtest.generated.Type2.Builder setE(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pravega.schemaregistry.test.integrationtest.generated.Type2.Builder clearE() {
      e = null;
    ...
    public Type2 build() {
      try {
        ...
        record.c = fieldSetFlags()[0] ? this.c : (java.lang.CharSequence) defaultValue(fields()[0]);
        record.d = fieldSetFlags()[1] ? this.d : (java.lang.Integer) defaultValue(fields()[1]);
        record.e = fieldSetFlags()[2] ? this.e : (java.lang.CharSequence) defaultValue(fields()[2]);
        return record;
