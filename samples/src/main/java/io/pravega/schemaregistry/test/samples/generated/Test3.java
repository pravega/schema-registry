...
public class Test3 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static io.pravega.schemaregistry.test.samples.generated.Test3.Builder newBuilder() {
    return new io.pravega.schemaregistry.test.samples.generated.Test3.Builder();
  }
   ...
   * @return A new Test3 RecordBuilder
   */
  public static io.pravega.schemaregistry.test.samples.generated.Test3.Builder newBuilder(io.pravega.schemaregistry.test.samples.generated.Test3.Builder other) {
    if (other == null) {
      return new io.pravega.schemaregistry.test.samples.generated.Test3.Builder();
    } else {
      return new io.pravega.schemaregistry.test.samples.generated.Test3.Builder(other);
    }
  }
   ...
   * @return A new Test3 RecordBuilder
   */
  public static io.pravega.schemaregistry.test.samples.generated.Test3.Builder newBuilder(io.pravega.schemaregistry.test.samples.generated.Test3 other) {
    if (other == null) {
      return new io.pravega.schemaregistry.test.samples.generated.Test3.Builder();
    } else {
      return new io.pravega.schemaregistry.test.samples.generated.Test3.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Test3>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.pravega.schemaregistry.test.samples.generated.Test3.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.pravega.schemaregistry.test.samples.generated.Test3 other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pravega.schemaregistry.test.samples.generated.Test3.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pravega.schemaregistry.test.samples.generated.Test3.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pravega.schemaregistry.test.samples.generated.Test3.Builder setField1(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pravega.schemaregistry.test.samples.generated.Test3.Builder clearField1() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pravega.schemaregistry.test.samples.generated.Test3.Builder setField2(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pravega.schemaregistry.test.samples.generated.Test3.Builder clearField2() {
      field2 = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pravega.schemaregistry.test.samples.generated.Test3.Builder setField3(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pravega.schemaregistry.test.samples.generated.Test3.Builder clearField3() {
      field3 = null;
