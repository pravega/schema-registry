...
public class Type1 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3911800834785457535L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Type1\",\"namespace\":\"io.pravega.schemaregistry.test.integrationtest.generated\",\"fields\":[{\"name\":\"a\",\"type\":\"string\"},{\"name\":\"b\",\"type\":\"int\"}]}");
   ...
   */
  public Type1(java.lang.CharSequence a, java.lang.Integer b) {
    this.a = a;
    this.b = b;
  }
   ...
   */
  public static io.pravega.schemaregistry.test.integrationtest.generated.Type1.Builder newBuilder() {
    return new io.pravega.schemaregistry.test.integrationtest.generated.Type1.Builder();
  }
   ...
   * @return A new Type1 RecordBuilder
   */
  public static io.pravega.schemaregistry.test.integrationtest.generated.Type1.Builder newBuilder(io.pravega.schemaregistry.test.integrationtest.generated.Type1.Builder other) {
    if (other == null) {
      return new io.pravega.schemaregistry.test.integrationtest.generated.Type1.Builder();
    } else {
      return new io.pravega.schemaregistry.test.integrationtest.generated.Type1.Builder(other);
    }
  }
   ...
   * @return A new Type1 RecordBuilder
   */
  public static io.pravega.schemaregistry.test.integrationtest.generated.Type1.Builder newBuilder(io.pravega.schemaregistry.test.integrationtest.generated.Type1 other) {
    if (other == null) {
      return new io.pravega.schemaregistry.test.integrationtest.generated.Type1.Builder();
    } else {
      return new io.pravega.schemaregistry.test.integrationtest.generated.Type1.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Type1>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.pravega.schemaregistry.test.integrationtest.generated.Type1.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.pravega.schemaregistry.test.integrationtest.generated.Type1 other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.a)) {
        this.a = data().deepCopy(fields()[0].schema(), other.a);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pravega.schemaregistry.test.integrationtest.generated.Type1.Builder setA(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pravega.schemaregistry.test.integrationtest.generated.Type1.Builder clearA() {
      a = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pravega.schemaregistry.test.integrationtest.generated.Type1.Builder setB(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pravega.schemaregistry.test.integrationtest.generated.Type1.Builder clearB() {
