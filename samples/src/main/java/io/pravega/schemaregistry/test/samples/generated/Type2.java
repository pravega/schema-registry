...
public class Type2 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static io.pravega.schemaregistry.test.samples.generated.Type2.Builder newBuilder() {
    return new io.pravega.schemaregistry.test.samples.generated.Type2.Builder();
  }
   ...
   * @return A new Type2 RecordBuilder
   */
  public static io.pravega.schemaregistry.test.samples.generated.Type2.Builder newBuilder(io.pravega.schemaregistry.test.samples.generated.Type2.Builder other) {
    if (other == null) {
      return new io.pravega.schemaregistry.test.samples.generated.Type2.Builder();
    } else {
      return new io.pravega.schemaregistry.test.samples.generated.Type2.Builder(other);
    }
  }
   ...
   * @return A new Type2 RecordBuilder
   */
  public static io.pravega.schemaregistry.test.samples.generated.Type2.Builder newBuilder(io.pravega.schemaregistry.test.samples.generated.Type2 other) {
    if (other == null) {
      return new io.pravega.schemaregistry.test.samples.generated.Type2.Builder();
    } else {
      return new io.pravega.schemaregistry.test.samples.generated.Type2.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Type2>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.pravega.schemaregistry.test.samples.generated.Type2.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.pravega.schemaregistry.test.samples.generated.Type2 other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.c)) {
        this.c = data().deepCopy(fields()[0].schema(), other.c);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pravega.schemaregistry.test.samples.generated.Type2.Builder setC(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pravega.schemaregistry.test.samples.generated.Type2.Builder clearC() {
      c = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pravega.schemaregistry.test.samples.generated.Type2.Builder setD(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pravega.schemaregistry.test.samples.generated.Type2.Builder clearD() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pravega.schemaregistry.test.samples.generated.Type2.Builder setE(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.pravega.schemaregistry.test.samples.generated.Type2.Builder clearE() {
      e = null;
