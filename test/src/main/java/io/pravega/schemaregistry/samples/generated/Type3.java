...
public class Type3 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Type3\",\"namespace\":\"io.pravega.schemaregistry.test.samples.generated\",\"fields\":[{\"name\":\"f\",\"type\":\"string\"},{\"name\":\"g\",\"type\":\"int\"},{\"name\":\"h\",\"type\":\"string\"},{\"name\":\"i\",\"type\":\"string\"}]}");
