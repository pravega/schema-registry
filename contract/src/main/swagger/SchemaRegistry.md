...
| allowMultipleSchemas | boolean | Flag to indicate whether to version schemas within the group by schema name. If set to true, addSchema will only validate against schemas that have the same schema name. | Yes |
