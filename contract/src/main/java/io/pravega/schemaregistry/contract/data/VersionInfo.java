 ...
 * the version and ordinal assigned by the service to the schema.  
 * 
 ...
 * {@link VersionInfo#ordinal} This is an Id that is assigned by the service and uniquely identifies the schema version within 
 * the group. The ordinals are assigned as monotonically increasing numbers for all schemas added to the group. 
 * So the ordinal also represents the absolute order of the schema for all schemas in the group. 
 */
@Data
@Builder
@AllArgsConstructor
