 ...
 * 
 * {@link VersionInfo#type} is same as {@link SchemaInfo#getType()} which represents the object type for which the version is computed. 
...
public class VersionInfo {
    /**
     * Object type which is declared in the corresponding {@link SchemaInfo#getType()} for the schemainfo that is identified 
     * by this version info. 
     */
    private @NonNull final String type;

    /**
     * Serialization format for the schema. 
     */
    private @NonNull final String serializationFormatName;
