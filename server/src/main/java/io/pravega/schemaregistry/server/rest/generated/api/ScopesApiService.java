...
public abstract class ScopesApiService {
    public abstract Response addSchemaToGroupIfAbsent(String scopeName,String groupName,AddSchemaRequest addSchemaRequest,SecurityContext securityContext) throws NotFoundException;
    public abstract Response addSchemaToSubgroupIfAbsent(String scopeName,String groupName,String subgroupName,AddSchemaRequest1 addSchemaRequest,SecurityContext securityContext) throws NotFoundException;
